...
(function ($) {
  $.fn.fullpage = function (options) {
    ...
    $('#section4')
      .find('.fp-tableCell')
      .css('height', getTableHeight($('#section4')) + 'px');
    ...
    $.fn.fullpage.reBuild = function (resizing) {
      ...
      $('.fp-section').each(function () {
        var scrollHeight =
          windowsHeight - parseInt($(this).css('padding-bottom')) - parseInt($(this).css('padding-top'));
    ...
    $('.fp-section')
      .each(function (index) {
        ...
        if (numSlides > 1) {
          ...
          $(this)
            .find('.fp-slides')
            .after('<div class="fp-controlArrow fp-prev"></div><div class="fp-controlArrow fp-next"></div>');
        ...
        if (!currentSection.hasClass('active')) {
          ...
          if (!isMoving) {
            $.isFunction(options.onLeave) &&
              options.onLeave.call(this, leavingSection, currentSection.index('.fp-section') + 1, yMovement);
    ...
    function getScrollSettings(v) {
      ...
      if (options.autoScrolling) {
        ...
        $('body').animate(
          { 'background-position-y': (-v.dtop / inaltime) * 30 },
          { queue: false, duration: 900, easing: 'easeInOutCirc' }
        );
        $('.section-image img:first').animate(
          { 'margin-top': (-v.dtop / inaltime) * 530 },
          { queue: false, duration: 900, easing: 'easeInOutCirc' }
        );
      ...
      if (!isScrolling) {
        ...
        if (section.length) {
          ...
          var isFirstScrollMove =
            typeof lastScrolledDestiny === 'undefined' && typeof slide === 'undefined' && !slideMoving;
